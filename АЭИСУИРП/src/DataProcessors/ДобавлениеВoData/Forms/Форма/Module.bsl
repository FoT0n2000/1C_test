...
&НаСервере
Процедура ДобавитьВИнтерфейсODataНаСервере()

	ПолучениеДанных();
	Объекты = новый Массив;
	МассивОбъектовМетаданных = ВыбранныеОбъектыМетаданных.ВыгрузитьЗначения(); 
	
	Для Каждого Строка из МассивОбъектовМетаданных Цикл
		
		Объекты.Добавить(Метаданные.НайтиПоПолномуИмени(Строка));	
...
&НаКлиенте
Процедура ДобавитьВИнтерфейсOData(Команда)
	ДобавитьВИнтерфейсODataНаСервере();
КонецПроцедуры
